      ...
      <div class="row">
         <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
            <div>
               ...
               <form action="chatting" method="post" id="formId">
                  <input type="hidden" name="number" id="number" value="" />
                  <a href="#" class="download-btn" style="width: 200px" id="submit">
                     <span class="iconify" data-icon="bx:conversation" data-width="40" data-height="40"></span>&nbsp 대화하기 
                  </a>
